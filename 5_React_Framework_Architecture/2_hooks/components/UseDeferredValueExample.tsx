  ...
  return (
      <View style={styles.container}>
        ...
        <View style={styles.statusContainer}>
          ...
          <Text style={styles.statusText}>Deferred value: {deferredValue}</Text>
        ...
        <Text style={styles.sectionTitle}>Generated List (deferred):</Text>
        ...
        <Text style={styles.explanation}>
          Typing stays responsive thanks to useDeferredValue and useTransition.
        </Text>
      </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  scrollView: { flex: 1, backgroundColor: "white", borderRadius: 8, marginBottom: 15 },
  listItem: { padding: 12, borderBottomWidth: 1, borderBottomColor: "#f0f0f0" },
  listItemText: { fontSize: 16, fontWeight: "500" },
  listItemSubtext: { fontSize: 12, color: "#666", marginTop: 2 },
  explanation: {
